...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="OSC_Topbar">
        <div id="VisitorInfo">
            当前访客身份：
            Johnny [ <a href="blog/uloginIndex">退出</a> ]
        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogCatalogManage">
                    <form id="CatalogForm" action="blog/addBlogCatalogs" method="post">
                        <h3> 添加博客分类 </h3>
                        ...
                        <label>排序值:</label><input name="sort_order" value="" size="3" type="text">
                        <span class="submit">
