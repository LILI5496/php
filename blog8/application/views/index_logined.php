...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title><?php echo $this->session->userdata('name')?>  - SYSIT个人博客</title>
...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
		  <?php echo $this->session->userdata('name')?> [ <a href="blog/uloginIndex">退出</a> ]
	...
	<div id="portrait"><a href="blog/center"><img src="assets/images/portrait.gif" alt="Johnny" title="Johnny" class="SmallPortrait" user="154693" align="absmiddle"></a></div>
    <div id="lnks">
...
<div class="BlogMenu"><div class="admin SpaceModule">
  <strong>博客管理</strong>
  <ul class="LinkLine">
	<li><a href="blog/publish_paper">发表博客</a></li>
